            ...
            <c:forEach var="assignments" items="${assignment}">
                <tr>
                 <td>${assignments.id}</td>
                    <td>${assignments.coursename}</td>
                    <td>${assignments.coursecode}</td>
                    <td>${assignments.semester}</td>
                    <td>${assignments.submissiondate}</td>
                    <td>
                        <!-- Provide download option -->
                        <a href="<c:url value='/downloadassignment?id=${assignments.id}' />" download>
